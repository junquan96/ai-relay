...
const content = {
  zh: {
    ...
    hero: {
      badge: 'OpenAI 兼容 · Vercel Edge · 开源',
      title: 'AI Relay',
      subtitle: '轻量级开源 AI API 中转服务',
      description: '把多个 Provider、多把 Key、Fallback、用量统计和 Admin 后台收进一个透明代理。客户端继续用 OpenAI 接口，团队获得更稳的模型入口。',
      quickstart: '快速开始',
      github: 'GitHub',
    ...
    stats: [
      ...
      { value: '2 min', label: 'Vercel 一键部署' },
      { value: 'Edge', label: '低延迟代理' },
    ],
    sections: {
  ...
  en: {
    ...
    hero: {
      badge: 'OpenAI-compatible · Vercel Edge · Open source',
      title: 'AI Relay',
      subtitle: 'Lightweight Open-Source AI API Relay',
      description: 'Unify providers, key pools, fallbacks, usage tracking, and an Admin console behind one transparent proxy. Keep your OpenAI clients, gain a steadier model gateway.',
      quickstart: 'Quick Start',
      github: 'GitHub',
      deploy: 'Deploy with Vercel',
    },
    stats: [
      ...
      { value: 'Edge', label: 'Low-latency proxy' },
    ],
    sections: {
      featuresEyebrow: 'FEATURES',
